...
public class SQLiteDataHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL("CREATE TABLE VENDA(ID_VENDA INTEGER PRIMARY KEY AUTOINCREMENT, ID_PRODUTO INTEGER NOT NULL, ID_CLIENTE INTEGER NOT NULL, FOREIGN KEY (ID_PRODUTO) REFERENCES PRODUTO(ID_PRODUTO), FOREIGN KEY (ID_CLIENTE) REFERENCES CLIENTE(ID_CLIENTE))");
